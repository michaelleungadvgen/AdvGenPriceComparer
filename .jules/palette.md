...
## 2024-05-25 - Semantic Navigation in Blazor
**Learning:** In Blazor applications, using `<div>` with `@onclick` handlers for navigation breaks keyboard accessibility and native browser features (like middle-click).
