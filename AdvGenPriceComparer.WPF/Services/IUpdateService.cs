...
public interface IUpdateService
{
    ...
    /// <param name="expectedFileHash">Expected SHA-256 hash of the downloaded file for security verification</param>
    /// <returns>True if download started successfully</returns>
    Task<bool> DownloadUpdateAsync(string downloadUrl, string expectedFileHash);
